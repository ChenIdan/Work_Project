...
require "/home/chen/nucleosome_model/lib/libattrib.pl";
...
if($print)
{
  if($xml)
  {
    open(PIPE, "| /home/chen/nucleosome_model/lib/format_xml.pl |");
    print PIPE $template;
    close(PIPE);
  }
  else
...
__DATA__
syntax: /home/chen/nucleosome_model/lib/bind.pl [OPTIONS] TEMPLATE [ASSIGNMENT_FILE1 ...] [VAR1=VAL1 VAR2=VAL2 ...]
