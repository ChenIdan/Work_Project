...
sub AddTemplate
{
    ...
    return "/home/chen/nucleosome_model/lib/bind.pl $template ";
}
...
sub RunGenie
{
    ...
    {
       $ENV{"LD_LIBRARY_PATH"} .= ":/home/chen/nucleosome_model/lib/";
    }
    else
    {
        $ENV{"LD_LIBRARY_PATH"} .= "/home/chen/nucleosome_model/lib/";
    ...
    {
	if (length($run_file) > 0) { `/home/chen/nucleosome_model/bin/map_learn_static $xml_file >& $run_file`; }
	else { `/home/chen/nucleosome_model/bin/map_learn_static $xml_file $error_output`; }
