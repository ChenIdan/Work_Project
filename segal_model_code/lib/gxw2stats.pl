...
require "/home/chen/nucleosome_model/lib/genie_helpers.pl";
...
my $exec_str = "/home/chen/nucleosome_model/lib/bind.pl /home/chen/nucleosome_model/templates/runs_weight_matrices_stats.map ";
...
if (length($regulator_scaling_factor) > 0)
{
  ...
  {
    my $matrices_str = `/home/chen/nucleosome_model/lib/gxw2consensus.pl $matrices_file | cut -f1`;
    my @matrices = split(/\n/, $matrices_str);
...
/home/chen/nucleosome_model/lib/gxw2stats.pl <gxw file>
