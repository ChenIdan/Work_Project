...
while(@ARGV)
{
  ...
  {
    die("/home/chen/nucleosome_model/lib/body.pl: Bad argument '$arg' given.  Use --help for help.");
  }
}
...
if($end < -1)
{
   $tmp_file = 'tmp_' . time . '.' . rand() . './home/chen/nucleosome_model/lib/body.pl';
...
__DATA__
Syntax: /home/chen/nucleosome_model/lib/body.pl BEG END < FILE
